...
2. Al menos **un PR** ejecutado para que aparezcan los checks `lint`, `test`, `smoke` en la lista de status checks.
...
| Status checks that are required | `lint`, `test`, `smoke` |
